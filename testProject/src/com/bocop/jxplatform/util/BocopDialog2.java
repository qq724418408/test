 ...
 * @author my
 */
public class BocopDialog2 extends Dialog {
	...
	public BocopDialog2(Context context) {
		super(context,R.style.Dialog_bocop);
		mContext = context;
		mContentView = View.inflate(context, R.layout.ui_bocop_dialog2, null);
		...
		ui_bocop_dialog_btn_cancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mNegativeListener != null) {
					mNegativeListener.onClick(BocopDialog2.this, R.id.ui_bocop_dialog_btn_cancel);
				}
				dismiss();
			}
		});
		ui_bocop_dialog_btn_confirm.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mPositiveListener != null) {
					mPositiveListener.onClick(BocopDialog2.this, R.id.ui_bocop_dialog_btn_confirm);
				}
				dismiss();
			}
		});
	 ...
	 * @param message 提示文字
	 */
	public BocopDialog2(Context context,String title,String message) {
		this(context);
		setTitle(title);
		setMessage(message);
	}
	 ...
	 */
	public BocopDialog2(Context context,int titleId,int messageId) {
