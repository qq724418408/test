...
import com.bocop.jxplatform.xml.CspXmlAPJJ14;
...
public class CarPhoneAddActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_titleName.setText("变更机动车所有人手机号");
...
//								Toast.makeText(CarAddActivity.this, "请前往中银开发平台实名认证", Toast.LENGTH_LONG).show();
	...
	private void requestCspForCarPhoneChange(){
		try {
			final CarInfoBean carInfoBean = new CarInfoBean(LoginUtil.getUserId(this), strLicenseType, "赣" + strLicenseNum, strOwnerName, strTel, strVehicleNum, strIdNo,"2");
			//生成CSP XML报文
			CspXmlAPJJ14 cspXmlAPJJ14 = new CspXmlAPJJ14(carInfoBean);
			String strXml = cspXmlAPJJ14.getCspXml();
			//生成MCIS报文
				...
				public void onSuccess(String responStr) {
					...
					try {
						...
						if (cspRecHeaderBean.getErrorcode().equals("00")) {
							...
							bundle.putString("title", "变更机动车所有人手机号");
							bundle.putString("tip",
									"已经成功变更机动车所有人手机号(" + carInfoBean.getTel() + ")，您可以在交通助手页面绑定车辆。");
							Intent intent = new Intent(
									CarPhoneAddActivity.this,
									TrafficSuccessActivity.class);
							intent.putExtras(bundle);
							startActivity(intent);
						} else {
							Toast.makeText(CarPhoneAddActivity.this,
