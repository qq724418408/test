...
public class TimePickerDialog {
    ...
    public TimePickerDialog(Context context,TimePickerDialogInterface interface1) {
        super();
        mContext = context;
        timePickerDialogInterface = interface1;
    }

    public TimePickerDialog(Context context,TimePickerDialogInterface interface1,String year,String month,String day) {
        super();
        mContext = context;
        timePickerDialogInterface = interface1;
        this.mYear=Integer.valueOf(year) ;
        this.mDay=Integer.valueOf(day);
        this.mMonth=Integer.valueOf(month);
    }
   

    private View initDateAndTimePicker(int ...style) {
        View inflate = LayoutInflater.from(mContext).inflate(
                R.layout.xfjr_dialog_datatime, null);
