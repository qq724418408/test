package com.bocop.xfjr.manager;
...
public class FullyLinearLayoutManager extends LinearLayoutManager {
	...
	private void logMeasureWarning(int child) {
		if (BuildConfig.DEBUG) {
			LogUtils.e("LinearLayoutManager--Can't measure child #" + child
	...
	private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize,
		...
		try {
			...
			if (BuildConfig.DEBUG) {
				LogUtils.e(
						"LinearLayoutManager--LinearLayoutManager doesn't work well with animations. Consider switching them off",
						e);
			}
			return;
		}
		...
		final int childHeightSpec = getChildMeasureSpec(heightSize,
				vPadding + vMargin + vDecoration, p.height, canScrollVertically());
	...
	private static void onMakeInsertDirtyFailed() {
		...
		if (BuildConfig.DEBUG) {
			LogUtils.e(
					"LinearLayoutManager:Can't make LayoutParams insets dirty, decorations measurements might be incorrect");
		}
	}
}
