...
public class FraudDetectionFragment_new6  extends BaseCheckProcessFragment implements StepSubject, BaseSwich {
	...
	protected void initView() {
		// 判断是否已经提交过了
		if (!productBean.isThreeSubmit()) {
			mHelper.add(fratment = new FraudDetectionFragment6_One(this));
		} else {
			mHelper.add(fratment = new AsyncResultFragment(this, AsyncResultFragment.THREE_CHECK));
		}
	}
