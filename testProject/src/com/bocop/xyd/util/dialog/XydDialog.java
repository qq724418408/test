 ...
 * Version : 1.0
 */
public class XydDialog extends Dialog {

    private AlertController mAlert;


    public XydDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public XydDialog create(){
        	if (P.mContext==null||P.mThemeResId==-1) {
				return null;
			}
            final XydDialog dialog = new XydDialog(P.mContext, P.mThemeResId);
        ...
        public XydDialog show() {
            final XydDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
